 ...
 <div class="container-fluid py-5">
    <div class="container py-5">
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="mb-4">
                    <a href="" class="h1 display-6">1000 Random & Interesting Facts About Literally Everything.
                       </a>
                </div>
                <div class="position-relative rounded overflow-hidden mb-3">
                    <img src="{{ asset('assets/img/1000.webp') }}" class="img-zoomin img-fluid rounded w-100"
                        alt="img">
                ...
                <div class="tab-class">
                    <div class="d-flex flex-column flex-md-row justify-content-between border-bottom mb-4">
                        <ul class="nav nav-pills d-inline-flex text-center mb-3 mb-md-0">
                            <li class="nav-item">
                                <h5 class="mt-2 mb-0">Tags:</h5>
                            </li>
                            <li class="nav-item">
                                <a class="d-flex py-2 bg-light rounded-pill active me-2" data-bs-toggle="pill"
                                    href="#tab-1">
                                    <span class="text-dark d-block d-md-inline" style="width: 100px;">Sports</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" href="#tab-2">
                                    <span class="text-dark d-block d-md-inline" style="width: 100px;">Magazine</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="d-flex py-2 bg-light rounded-pill me-2" data-bs-toggle="pill" href="#tab-3">
                                    <span class="text-dark d-block d-md-inline" style="width: 100px;">Politics</span>
                                </a>
                            </li>
                        </ul>
                ...
                <div class="mb-4">
                    <a href="" class="h1 display-6">German Chocolate Cake is named after an American baker by the name of Samuel German.
                       </a>
                </div>
                <div class="position-relative rounded overflow-hidden mb-3">
                    <img src="{{ asset('assets/img/cake.webp') }}" class="img-zoomin img-fluid rounded w-100"
                        alt="img">
                            ...
                            <div class="row g-4">
                                        ...
                                        <div class="col-4">
                                            <div class="square position-relative">
                                                <div class="overflow-hidden rounded-circle">
                                                    <img src="{{ asset('assets/img/side1.webp') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="position-relative banner-2">
                                        <img src="{{ asset('assets/img/side1.webp') }}" class="img-fluid w-100 rounded" alt="img">
                                        <div class="text-center banner-content-2">
                                            <h6 class="mb-2">The Most Populer</h6>
                                            <p class="text-white mb-2">News & Magazine WP Theme</p>
                                            <a href="#" class="btn btn-primary text-white px-4">View Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="{{asset('assets/img/goose-facts.webp')}}" class="card-img-top" alt="Classical Dance class">
                    <div class="card-body">
                        <h4 class="card-title">Classical Dance class</h4>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni vero excepturi blanditiis quidem.</p>
                        <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4">Explore Details</a>
                    </div>
                </div>
            </div>
            <!-- Card 2 -->
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="{{asset('assets/img/august.webp')}}" class="card-img-top" alt="Classical Dance class">
                    <div class="card-body">
                        <h4 class="card-title">Classical Dance class</h4>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni vero excepturi blanditiis quidem.</p>
                        <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4">Explore Details</a>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="{{asset('assets/img/bali-facts.webp')}}" class="card-img-top" alt="Classical Dance class">
                    <div class="card-body">
                        <h4 class="card-title">Classical Dance class</h4>
                        <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magni vero excepturi blanditiis quidem.</p>
                        <a href="#" class="btn btn-primary rounded-pill text-white py-2 px-4">Explore Details</a>
