...
@section('content')
    <!-- Header Section -->
    <top class="internet text-white text-center py-5">
        <div class="container">
    ...
    <section class="container text-center py-5" style="max-width: 1200px;">
        ...
        <p class="lead">We provide high-speed internet services with a focus on reliability, security, and customer
            satisfaction. Our mission is to keep you connected with the world at blazing speeds.</p>
    </section>
