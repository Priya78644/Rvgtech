    ...
    <main class="container my-5">
        ...
        <section id="section1" class="mb-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text text-dark">Education is a fundamental aspect of human development and personal
                        growth...</p>
                </div>
            </div>
        </section>
        ...
        <section id="section2" class="mb-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text text-dark">Education offers numerous benefits, including improved career
                        prospects...</p>
                </div>
            </div>
        </section>
        ...
        <section id="section4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text text-dark">Education remains one of the most powerful tools for creating positive
                        change...</p>
                </div>
            </div>
        </section>
