...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="mb-4">
                    <a href="" class="h1 display-6">Manish Sisodia Gets Bail From SC In Delhi Excise Policy Cases, To Walk Out of Jail After 17 Months.</a>
                </div>
                <div class="position-relative rounded overflow-hidden mb-3">
                    <img src="{{asset('assets/img/modi.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                ...
                <div class="bg-light p-4 mb-4 rounded border-start border-3 border-primary">
                    <h1 class="mb-2">ED Assistant Director Lands in CBI Net, Third Officer from Agency Caught Taking Bribes since November.</h1>
                </div>
                <div class="row g-4">
                    <div class="col-6">
                ...
                <div class="bg-light rounded my-4 p-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center p-3 bg-white rounded">
                                <img src="{{asset('assets/img/modi.jpg')}}" class="img-fluid rounded" alt="">
                                <div class="ms-3">
                                    <a href="#" class="h5 mb-2">Lorem Ipsum is simply dummy text of the printing</a>
                                    <p class="text-dark mt-3 mb-0 me-3"><i class="fa fa-clock"></i> 06 minute read</p>
                                </div>
                ...
                {{-- <div class="bg-light rounded p-4 my-4">
                    ...
                    <form action="#">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <button class="form-control btn btn-primary text dark py-3" type="button">Submit Now</button>
                            </div>
                        </div>
                    </form>
                </div> --}}
